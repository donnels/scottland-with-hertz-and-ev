...
Post Script: Filled out a post rental Hertz survey and was promised a call back and have yet to receive one.
...
We have been checking the mailbox since the rental for responses to our questions to Hertz and now have discovered a new low. Hertz has sent us a bill for charging (a guess) with just a summary price and no details of units charged or unit cost and have set the subject to "reminder for overdue charges". A reminder implies previous communications although there was none. Working in security one is often reminded to be wary of threatening mails sent out of context, setting a short deadline on nebulous costs with links in them. This is one. I can guess that it's from when I used the Shell fob at the lancaster filling station but there is no way to tell as there are no details and just threats that if I don't pay within the next two days it will be sent to debt collectors. The price also seems steep if it was for that. It seems you should also beware of Hertz's "we charge fair prices for charging" claims. The Hertz definition of fair seems to differ to mine but even so I'd pay if they can at least say what it is I'm paying for. It looks like I should have avoided the Shell fob at all costs as it just causes more trouble on top of sitting for a long tine (22% longer) at a filling station on a slower than advertised charger.
